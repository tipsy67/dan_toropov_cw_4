...
def test_vacancy_to_json(test_00_vacancy):
    test_dict = {
        'area': 'Великобритания',
...
def test_vacancy_dataframe(test_00_vacancy):
    Vacancy.clear_data_frame()
    assert Vacancy.data_frame == {
        'name': [],
        'salary_min': [],
        'salary_max': [],
        'area': [],
    ...
    Vacancy.vacancy_to_data_frame(test_00_vacancy)
    assert Vacancy.data_frame == {
        'name': ["Back-End Engineer - Python, Django, AWS, Integrations"],
        'salary_min': [89051],
        'salary_max': [445257],
